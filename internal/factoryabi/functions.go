...
var Functions = []FunctionDef{
	{Name: "getAddress", Label: "Get User Wallet Address", Description: "Predict deterministic deposit address for a userId (no deployment needed).", Type: "read", Role: "any", Inputs: []Param{{Name: "userId", Type: "uint256", Label: "User ID", Placeholder: "1"}}},
	...
	{Name: "deployWallet", Label: "Deploy Wallet", Description: "Deploy user forwarder wallet (relayer only).", Type: "write", Role: "relayer", Inputs: []Param{{Name: "userId", Type: "uint256", Label: "User ID", Placeholder: "1"}}},
	{Name: "deployAndSweepNative", Label: "Deploy And Sweep Native", Description: "Deploy user forwarder wallet if needed, then sweep native balance to mother wallet.", Type: "write", Role: "relayer", Inputs: []Param{{Name: "userId", Type: "uint256", Label: "User ID", Placeholder: "1"}}},
	{Name: "deployAndSweepToken", Label: "Deploy And Sweep Token", Description: "Deploy user forwarder wallet if needed, then sweep token balance to mother wallet.", Type: "write", Role: "relayer", Inputs: []Param{{Name: "userId", Type: "uint256", Label: "User ID", Placeholder: "1"}, {Name: "token", Type: "address", Label: "Token Address", Placeholder: "T... or 0x..."}}},
	...
	{Name: "emergencyWithdrawNative", Label: "Emergency Withdraw Native", Description: "Owner rescues native token from a user wallet to mother wallet.", Type: "write", Role: "owner", Inputs: []Param{{Name: "userId", Type: "uint256", Label: "User ID", Placeholder: "1"}}},
	{Name: "emergencyWithdrawToken", Label: "Emergency Withdraw Token", Description: "Owner rescues token from a user wallet to mother wallet.", Type: "write", Role: "owner", Inputs: []Param{{Name: "userId", Type: "uint256", Label: "User ID", Placeholder: "1"}, {Name: "token", Type: "address", Label: "Token Address", Placeholder: "T... or 0x..."}}},
