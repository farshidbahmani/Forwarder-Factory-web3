...
const NETWORKS = [
  ...
  { name: "arbitrumSepoliaTestnet", chainId: 421614,   symbol: "ETH",   url: process.env.ARBITRUM_SEPOLIA_TESTNET_RPC      || "https://sepolia-rollup.arbitrum.io/rpc" },
  { name: "optimismMainnet",        chainId: 10,       symbol: "ETH",   url: process.env.OPTIMISM_MAINNET_RPC              || "https://mainnet.optimism.io" },
  { name: "optimismSepoliaTestnet", chainId: 11155420, symbol: "ETH",   url: process.env.OPTIMISM_SEPOLIA_TESTNET_RPC      || "https://sepolia.optimism.io" },
  { name: "baseMainnet",            chainId: 8453,     symbol: "ETH",   url: process.env.BASE_MAINNET_RPC                  || "https://mainnet.base.org" },
  { name: "baseSepoliaTestnet",     chainId: 84532,    symbol: "ETH",   url: process.env.BASE_SEPOLIA_TESTNET_RPC          || "https://sepolia.base.org" },
  { name: "avalancheMainnet",       chainId: 43114,    symbol: "AVAX",  url: process.env.AVALANCHE_MAINNET_RPC             || "https://api.avax.network/ext/bc/C/rpc" },
  { name: "avalancheFujiTestnet",   chainId: 43113,    symbol: "AVAX",  url: process.env.AVALANCHE_FUJI_TESTNET_RPC        || "https://api.avax-test.network/ext/bc/C/rpc" },
] as const;
